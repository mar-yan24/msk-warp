...
``probes-DE-preregistration.md`` E.3 and are read from there.
"""
...
#: The one seed. Recorded here, before any launch: seed 1001 matches probe D's
#: cell, and is the seed whose selected duration rose with training in 4 of 4
#: stage-1 recipes. One seed supports no interval and no ordering, which is a
#: named confound of E.2, not a property this choice repairs.
